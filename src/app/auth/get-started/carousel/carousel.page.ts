...
export class CarouselPage implements OnInit, AfterViewInit {
  ...
  slidesContent = [
    {
      title: 'Disclaimer',
      description: 'PhilSafe is an online platform designed for reporting incidents only. For emergencies, please contact your local police station immediately.',
      button: 'Next'
    },
    {
